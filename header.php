...
<div id="wrapper">
		<header id="header">
			<div class="container">
				<div class="logo"><a href="./index.php"><img  src="images/main-logo.png" alt="ScrapRecycle" class="main-logo" width=200 height=60></a></div>
				<nav id="nav">
					<div class="opener-holder">
						<a href="#" class="nav-opener"><span></span></a>
					</div>
					   
					<a href="sell.php" class="btn btn-success rounded"><i class="fa fa-phone"></i><b>+91 9030882571</b> </a> 
					<div class="nav-drop">
						<ul>
						
							<li class="active visible-md visible-sm visible-xs"><a href="#">welcome guest</a></li>
							<li><a href="./rates.php">PriceList</a></li>
